...
public class Task4 {
    public static void main(String[] args)  {
        // 1
        List<Integer> numbers_list = Arrays.asList(1, 2, 3, 4, 4, 4, 2, 1, 9, 8);
    ...
    public static double getAverage(List<Integer> numbers_list) {
    ...
    public static List<String> changeString(List<String> strings_list) {
    ...
    public static <T extends Number> List<Double> squareNumbers (List<T> number_list_squire) {
    ...
    public static int getSumEvenNumbered(int[] arr) {
